        ...
        return (
            <div className={style.userInfo}>
                <div className={style.headerInfo}>
                    ...
                    <p className={style.name}>Alexander Velikodnyy</p>
                    <p>@Belython</p>
                ...
                <div className={style.stats}>
                    <div className={style.statsBlock}>
                        ...
                        <p className={style.statsText}>Posts</p>
                    </div>
                    <div className={style.statsBlock}>
                        <p className={style.statsTitle}>228</p>
                        <p className={style.statsText}>Friends</p>
                    </div>
                    <div>
                        <p className={style.statsTitle}>1488</p>
                        <p className={style.statsText}>Comments</p>
                    </div>
                </div>
